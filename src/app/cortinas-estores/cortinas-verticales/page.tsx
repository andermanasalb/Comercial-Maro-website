...
export const metadata: Metadata = buildMetadata({
  title: "Cortinas Verticales | Comercial MAR'O",
  description:
    'Cortinas verticales con lamas ajustables para el control elegante de luz e intimidad en grandes superficies. Ideales para ventanales y puertas correderas. Bilbao.',
  keywords: ['cortinas verticales', 'lamas verticales', 'cortinas grandes ventanales', 'cortinas interiores Bilbao'],
  path: '/cortinas-estores/cortinas-verticales',
})

const features = [
  'Lamas verticales ajustables para regular la entrada de luz e intimidad a la vez',
  'Sistema ideal para cubrir grandes ventanales y superficies acristaladas',
  'Líneas visuales elegantes y ordenadas que estructuran el espacio',
  'Posibilidad de orientar las lamas para crear distintos ambientes',
  'Disponible en tejidos screen, blackout y decorativos',
  'Perfecta para puertas correderas y zonas de paso al exterior',
  'Fácil accionamiento manual con cadena o sistema motorizable',
]

const specs: [string, string][] = [
  ['Sistema',       'Cortina vertical'],
  ['Ancho máx.',    'Hasta 5,80 m'],
  ['Alto máx.',     'Hasta 4,00 m'],
  ['Ancho lama',    '89 mm / 127 mm'],
  ['Inclinación',   'Hasta 50º'],
...
export default function CortinasVerticalesPage() {
  return (
    <div className="min-h-screen">
      {/* ── Hero ─────────────────────────────────────────────────────────── */}
      <div className="relative h-[40vh] min-h-48 flex items-end">
        <Image
          src="https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=1200&q=80"
          alt="Cortinas verticales en gran ventanal"
          fill
          sizes="100vw"
        ...
        <div className="relative z-10 px-6 pb-8 max-w-site mx-auto w-full">
          <nav className="text-white/60 text-[12px] font-montserrat mb-2">
            ...
            {' / '}
            <span className="text-white" aria-current="page">Cortinas Verticales</span>
          </nav>
          ...
          <h1 className="font-montserrat text-3xl font-extrabold text-white">Cortinas Verticales</h1>
        </div>
      </div>
      ...
      <div className="max-w-site mx-auto px-6 py-14 grid lg:grid-cols-[1fr_320px] gap-12">
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start mb-10">
            <div>
              <p className="text-gris-medio text-base leading-relaxed mb-4">
                En <strong className="text-carbon font-semibold">Comercial MAR&apos;O</strong> las cortinas verticales son la solución de referencia para cubrir grandes superficies acristaladas con elegancia. Sus lamas verticales orientables permiten controlar simultáneamente la entrada de luz y el nivel de privacidad, adaptándose a cada momento del día con un simple giro de las lamas.
              </p>
              <p className="text-gris-medio text-base leading-relaxed">
                Su <strong className="text-carbon font-semibold">línea visual limpia y ordenada</strong> aporta estructura al espacio y resulta especialmente adecuada en grandes ventanales, puertas correderas y zonas de paso hacia el exterior. Disponibles en una completa selección de tejidos para cada uso y decoración.
              </p>
            </div>
            <div className="img-zoom-wrap">
              <Image
                src="https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=800&q=80"
                alt="Cortinas verticales en interior con gran ventanal"
                width={800}
                height={600}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-10">
            {[
              { val: 'Verticales',    label: 'Lamas' },
              { val: 'Gran formato',  label: 'Superficie', highlight: true },
              { val: 'Simultáneo',    label: 'Luz e intimidad' },
              { val: 'Sencillo',      label: 'Manejo' },
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start mb-10">
            ...
            <div className="img-zoom-wrap shadow-sm">
              <Image
                ...
                alt="Detalle lamas verticales orientadas"
                width={800}
                height={600}
                className="w-full h-auto object-cover img-zoom img-reveal"
          ...
          <div className="mb-10">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[
                { name: 'Grandes ventanales', desc: 'La solución más eficiente para cubrir superficies acristaladas de gran tamaño.' },
                { name: 'Puertas correderas', desc: 'Se adapta perfectamente a puertas de acceso a terrazas y jardines.' },
                { name: 'Oficinas y salones', desc: 'Control de luz profesional que mantiene el orden visual del espacio.' },
              ].map(u => (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-10">
            {[
              { name: 'Screen técnico', desc: 'Alto rendimiento solar. Filtra el calor sin bloquear la vista al exterior.' },
              { name: 'Blackout',       desc: 'Opacidad total, ideal cuando se necesita oscuridad completa.' },
              { name: 'Decorativo',     desc: 'Colores lisos y semitransparentes para integrarse en cualquier decoración.' },
            ].map(t => (
        ...
        <div className="lg:sticky lg:top-20 h-fit space-y-4">
          <div className="bg-crema rounded-xl p-6 border border-gris-claro shadow-sm">
            <h3 className="font-montserrat text-base font-bold text-carbon mb-2">
              ¿Tienes un gran ventanal?
            </h3>
            <p className="text-sm text-gris-medio mb-5">
              Las cortinas verticales son nuestra solución más recomendada para grandes superficies. Cuéntanos tu proyecto.
            </p>
