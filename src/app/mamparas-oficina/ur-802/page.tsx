...
export default function UR802Page() {
  return (
      ...
      <div className="relative h-[40vh] min-h-48 flex items-end">
        ...
        <div className="relative z-10 px-6 pb-8 max-w-site mx-auto w-full">
          <nav className="text-white/60 text-[12px] font-montserrat mb-2">
            ...
            {' / '}
            <span className="text-white" aria-current="page">UR-802</span>
          </nav>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start mb-10">
            ...
            <div className="flex flex-col gap-6">
              <div className="img-zoom-wrap flex items-center justify-center">
                <Image
                  src="/images/mamparas-oficina/UR-802-1.jpg"
                  alt="Mampara UR-802 instalación oficina"
                  width={800}
                  height={800}
                  unoptimized
              ...
              <a
                href="/docs/mamparas-oficina/Ur-802.pdf"
                target="_blank"
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start mb-10">
            ...
            <div className="img-zoom-wrap shadow-sm flex items-center justify-center">
              <Image
                src="/images/mamparas-oficina/UR-802-2.jpg"
                alt="Detalle perfilería UR-802"
                width={800}
                height={800}
                unoptimized
          ...
          <div className="mb-14">
            ...
            <p className="text-sm text-gris-medio mb-6">
              El sistema UR-802 permite resolver cualquier necesidad funcional y arquitectónica mediante una extensa 
            ...
            {[
              {
                ...
                rows: [
                  { series: 'UR-802', pct: '80%', val: 'Alta', current: true, delay: '0s' },
              ...
              },
              {
                ...
                rows: [
                  { series: 'UR-802', pct: '70%', val: 'Media', current: true, delay: '0s' },
              ...
              },
              {
                ...
                rows: [
                  { series: 'UR-802', pct: '50%', val: 'Media', current: true, delay: '0s' },
        ...
        <div className="lg:sticky lg:top-20 h-fit space-y-4">
          <div className="bg-crema rounded-xl p-6 border border-gris-claro shadow-sm">
            ...
            <p className="text-sm text-gris-medio mb-5">
              Si buscas robustez y resistencia certificada al fuego, el UR-802 es tu sistema. Cuéntanos tu proyecto.
            </p>
