...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${SITE_URL}/ventanas-pvc`,            changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/ventanas-aluminio`,       changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/cerramientos`,            changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/barandillas`,             changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/mamparas-ducha`,          changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/mamparas-oficina`,        changeFrequency: 'monthly', priority: 0.8 },
