...
export const metadata: Metadata = buildMetadata({
  ...
  description: 'Cerramientos de aluminio y vidrio para terrazas, galerías y patios. Amplía tu espacio habitable con luz natural. Presupuesto gratis en Bilbao.',
  keywords: ['cerramientos terraza Bilbao', 'cerramiento aluminio Vizcaya', 'galería acristalada Bizkaia'],
  path: '/cerramientos',
})

const features = [
  'Sistemas correderos sin marco',
  'Aluminio lacado y anodizado',
  'Vidrio templado de seguridad',
  'Máxima entrada de luz natural',
  'Perfiles de bajo perfil visibles',
  'Garantía 10 años en fabricación e instalación',
]

const finishes = ['Blanco', 'Gris antracita', 'Negro', 'Bronce', 'Plata', 'Personalizado RAL']

export default function CerramientosPage() {
  return (
    <div className="min-h-screen">
      <div className="relative h-64 flex items-end">
        <Image src="https://images.unsplash.com/photo-1574362848149-11496d93a7c7?w=1200" alt="Cerramientos de terraza Bilbao" fill sizes="100vw" className="object-cover" />
        ...
        <div className="relative z-10 px-6 pb-8 max-w-[1280px] mx-auto w-full">
          <nav className="text-white/60 text-[12px] font-montserrat mb-2">
            <Link href="/" className="hover:text-white">Inicio</Link> / <span className="text-white">Cerramientos</span>
          </nav>
          <h1 className="font-montserrat text-3xl font-extrabold text-white">Cerramientos de Terraza</h1>
        </div>
      </div>
      ...
      <div className="max-w-[1280px] mx-auto px-6 py-14 grid lg:grid-cols-[1fr_320px] gap-12">
        <div>
          <p className="text-gris-medio text-base leading-relaxed mb-4">
            Cerramos terrazas, galerías y patios transformándolos en espacios habitables durante todo el año. Nuestros sistemas de carpintería de aluminio maximizan la entrada de luz y las vistas mientras protegen del viento y la lluvia característica del norte.
          </p>
          <p className="text-gris-medio text-base leading-relaxed mb-10">
            Utilizamos sistemas correderos de última generación que desaparecen visualmente, manteniendo la estética de tu espacio exterior con total apertura cuando el tiempo lo permite.
          </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-10">
            {[1,2,3,4,5,6].map(i => (
              <div key={i} className="relative h-36 rounded-lg overflow-hidden">
                <Image src={`https://images.unsplash.com/photo-1574362848149-11496d93a7c7?w=400&h=300&sig=${i}`} alt={`Cerramiento terraza ${i}`} fill sizes="(max-width: 640px) 50vw, 33vw" className="object-cover hover:scale-105 transition-transform" />
              </div>
            ))}
          </div>
        ...
        <div className="lg:sticky lg:top-24 h-fit">
          <div className="bg-crema rounded-xl p-6 border border-gris-claro">
            <h3 className="font-montserrat text-[15px] font-bold text-carbon mb-2">¿Quieres cerrar tu terraza?</h3>
