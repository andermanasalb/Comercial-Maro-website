  ...
  return (
    <div className="min-h-screen">
      <div className="relative h-64 flex items-end">
        <Image src="https://images.unsplash.com/photo-1616137466211-f939a420be84?w=1200" alt="Pérgolas bioclimáticas Bilbao" fill className="object-cover" />
        ...
        <div className="relative z-10 px-6 pb-8 max-w-[1280px] mx-auto w-full">
          <nav className="text-white/60 text-[12px] font-montserrat mb-2">
            <Link href="/" className="hover:text-white">Inicio</Link> / <span className="text-white">Pérgolas Bioclimáticas</span>
          </nav>
      ...
      <div className="max-w-[1280px] mx-auto px-6 py-14 grid lg:grid-cols-[1fr_320px] gap-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-10">
            {[1,2,3,4,5,6].map(i => (
              <div key={i} className="relative h-36 rounded-lg overflow-hidden">
                <Image src={`https://images.unsplash.com/photo-1616137466211-f939a420be84?w=400&h=300&sig=${i}`} alt={`Pérgola bioclimática ${i}`} fill className="object-cover hover:scale-105 transition-transform" />
              </div>
            ))}
          </div>
        ...
        <div className="lg:sticky lg:top-24 h-fit">
          <div className="bg-crema rounded-xl p-6 border border-gris-claro">
            <h3 className="font-montserrat text-[15px] font-bold text-carbon mb-2">¿Te interesa una pérgola?</h3>
